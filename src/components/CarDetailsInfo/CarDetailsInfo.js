...
import { Container, ContainerInfo, Img, IteamAbout, ItemsAccessories, ItemsCondition, Link, ListAbout, ListAccessories, ListCondition, Span, Text, TextBlue, TextBlueFont, Title, TitleInfo } from './CarDetailsInfo.styled';
...
const newRentalPrice = priceWithoutDollar + "$";
  ...
  return (
    <Container>
      ...
      <Title>
        {carAllInfo.make} <TextBlue>{carAllInfo.model}</TextBlue>, {carAllInfo.year}
      </Title>
      <IteamAbout>
        <ListAbout>
          {addressSplit[1]} <Span />
      ...
      <ContainerInfo>
        ...
        <ItemsCondition>
          <ListCondition>Minimum age: <TextBlueFont>{minAge}</TextBlueFont></ListCondition>
          <ListCondition>{validDriver}</ListCondition>
          <ListCondition>{security}</ListCondition>
          <ListCondition>Mileage: <TextBlueFont>{formattedMileage}</TextBlueFont></ListCondition>
          <ListCondition>Price: <TextBlueFont>{newRentalPrice}</TextBlueFont></ListCondition>
        </ItemsCondition>
      </ContainerInfo>
